...
import { ChevronDown, ChevronLeft, ChevronRight, Calendar, Clock, FileText, Plus, Dumbbell, Layers, MoreVertical, Trash2, RefreshCw, Scale, X, Flame, Zap, Check, Timer, ArrowLeftRight, Lock, Ruler, Settings, Hash, Repeat } from 'lucide-react-native';
...
import type { Workout, WorkoutMode, ExerciseLibraryItem, ExerciseStatsMap, ExerciseItem, Exercise, Set, RestPeriodSetInfo, FocusNextSet, GroupType, SetType, ExerciseCategory, ExerciseGroup, Note, GroupSetType, DistanceUnitSystem, DistanceUnit } from '@/types/workout';
...
const styles = StyleSheet.create({
  ...
  // Active state styling for "Multiply weight x 2" option
