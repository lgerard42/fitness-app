...
import { useWorkoutTemplateDragAndDrop } from './WorkoutTemplateDragAndDrop';
...
const WorkoutTemplate: React.FC<WorkoutTemplateProps> = ({
  ...
  const { renderDragItem, dragKeyExtractor } = useWorkoutTemplateDragAndDrop({
    dragItems,
    isDragging,
    collapsedGroupId,
    itemHeights,
...
const styles = StyleSheet.create({
  ...
  // Drag Mode Styles (only dragListContent remains, others moved to WorkoutTemplateDragAndDrop.tsx)
  dragListContent: {
    paddingHorizontal: 6,
    paddingTop: 0,
    paddingBottom: 100,
